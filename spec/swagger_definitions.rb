module SwaggerDefinitions
  ...
  def list_posts_def
    pagination_properties(
        {
            type: :array, items: SWAGGER_DOCS_PARSER.call(ReadModel::Mappers::ListPostMapper::PostDTO)
        }
    )
  end

  def post_details_def
    SWAGGER_DOCS_PARSER.call(ReadModel::Mappers::PostDetailsMapper::PostDTO)
  end
end
